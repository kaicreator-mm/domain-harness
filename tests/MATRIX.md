...
| --- | --- | --- |
| Core portable unit + nested suites | `npm test -w @kaicreator/domain-harness` (recursive `tests/**/*.test.ts` + `tsconfig.test.json` typecheck) | 39 files / 208 tests, incl. `tests/discovery/nested/sentinel.test.ts` proving recursion |
