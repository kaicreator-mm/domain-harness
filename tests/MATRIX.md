...
| --- | --- | --- |
| Core portable unit + nested suites | `npm test -w @kaicreator/domain-harness` (recursive `tests/**/*.test.ts` + `tsconfig.test.json` typecheck) | 44 files / 228 tests, incl. `tests/discovery/nested/sentinel.test.ts` proving recursion |
