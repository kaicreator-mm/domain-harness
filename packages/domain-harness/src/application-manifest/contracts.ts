...
import type {
  ...
  DacReferenceBaseline,
  DacReferenceBaselineInput,
 ...
 */
export type UxBridgeContractReference =
  | DomainIntentRef
  | SemanticTargetRef
  | CommandRef
  | OutcomeRef
...
import type {
  ...
  SelectedCompositionValidation,
} from '../composition-intake/contracts.js';
import type {
 ...
 */
export const APPLICATION_MANIFEST_ADAPTER_VERSION =
  'application-manifest-adapter/1' as const;
 ...
 */
export const APPLICATION_MANIFEST_CONTRACT_VERSION =
  'dac-application-manifest/v0.0.2' as const;

/** Exact identity of the composition-evidence surface minted by #310. */
export const MANIFEST_COMPOSITION_ADAPTER_VERSION = 'manifest-composition/1' as const;

/** Exact identity of the manifest↔binding correlation surface minted by #310. */
export const MANIFEST_BINDING_CORRELATION_VERSION =
  'manifest-binding-correlation/1' as const;

/** Exact identity of the manifest↔activation correlation surface minted by #310. */
export const MANIFEST_ACTIVATION_CORRELATION_VERSION =
  'manifest-activation-correlation/1' as const;
 ...
 */
export type ApplicationManifestErrorCode =
