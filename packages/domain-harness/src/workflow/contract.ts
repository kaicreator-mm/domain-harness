...
export type DomainWorkflowTrigger =
  ...
  | { readonly kind: 'invocation_done'; readonly invocationKey: string }
  | { readonly kind: 'invocation_failed'; readonly invocationKey: string }
  | { readonly kind: 'wait'; readonly waitKey: string }
  | { readonly kind: 'timer'; readonly timerKey: string }
  | { readonly kind: 'deadline'; readonly deadlineKey: string }
  | { readonly kind: 'callback'; readonly callbackKey: string }
  | { readonly kind: 'recovery'; readonly recoveryKey: string };
