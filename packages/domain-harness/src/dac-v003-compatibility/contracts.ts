 ...
 */
export type DacV003UxRoleAnchor =
  | DomainIntentRef
  | SemanticTargetRef
  | ViewRef
  | SnapshotRef
...
export const DAC_V003_COMPATIBILITY_AUTHORITY_VERSION =
  'dac-v003-compatibility-authority/1' as const;
 ...
 */
export const DAC_V003_COMPATIBILITY_AUTHORITY_SCOPE =
  'domain-harness://dac-v003/compatibility-validation' as const;
...
export interface DacV003CapabilityRequirement {
  ...
  readonly reference: DacV003RegistryReference & { readonly role: 'capability-requirement' };
...
export interface DacV003PortRequirement {
  readonly kind: 'port';
  readonly reference: DacV003RegistryReference & { readonly role: 'port-requirement' };
  readonly strength: DacV003RequirementStrength;
  readonly condition?: string;
...
export type DacV003CompositionRequirement =
  | DacV003CapabilityRequirement
  | DacV003PortRequirement
  | { readonly kind: 'host-binding'; readonly reference: RuntimeHostBindingRequirementRef };

/** The three roles whose references can be satisfied by evidence. */
export type DacV003SatisfiableReferenceRole =
...
export interface DacV003RequirementSatisfactionEvidence {
  ...
  readonly requirement: DacV003Reference & { readonly role: DacV003SatisfiableReferenceRole };
 ...
 */
export type DacV003CompatibilityErrorCode =
...
export class DacV003CompatibilityError extends Error {
  ...
  constructor(
    code: DacV003CompatibilityErrorCode,
    message: string,
