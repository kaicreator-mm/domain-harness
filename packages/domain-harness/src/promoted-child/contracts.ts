...
export const PROMOTED_CHILD_BODY_SCHEMA_VERSION = 'promoted-child-workflow/v1' as const;
...
export type PromotedChildSelector =
  | { readonly kind: 'exact-digest'; readonly artifact: PromotedArtifactIdentity }
...
/* ------------------------------------------------------------------------ */
/* Promoted subworkflow body schema (declarative, engine-neutral IR)         */
/* ------------------------------------------------------------------------ */
...
export type PromotedChildValueSource =
  ...
  | { readonly kind: 'step-output'; readonly node: string; readonly path: string };
...
export type PromotedChildStep =
  | PromotedChildQueryStep
  | PromotedChildEmitEventStep
  | PromotedChildEffectIntentStep
  | PromotedChildTerminalStep
  | PromotedChildReasonedStep;
...
/* ------------------------------------------------------------------------ */
/* Terminal result (data for parent admission; never an executed effect)     */
/* ------------------------------------------------------------------------ */
...
export type DynamicChildExecutionErrorCode =
...
export const FALLTHROUGH_ELIGIBLE_CODES: readonly DynamicChildExecutionErrorCode[] = [
  'DYNAMIC_CHILD_INCOMPATIBLE',
  'DYNAMIC_CHILD_NOT_APPLICABLE',
] as const;
