...
import type { ApplicationSelectionRef, CompatibilityTargetRef, PromotionDecisionRef, RuntimeContractRef, RuntimeImplementationRef, SelectedDomainDataRef } from '../dac/contracts.js';
/** Exact identity of this intake surface, carried by every validation verdict. */
export declare const COMPOSITION_INTAKE_ADAPTER_VERSION: "composition-intake/1";
/**
 ...
 */
export type CompositionIntakeErrorCode = 'INVALID_COMPOSITION_INTAKE' | 'SELECTED_IDENTITY_MISMATCH' | 'PROVENANCE_CHAIN_MISMATCH' | 'RUNTIME_CONTRACT_MISMATCH' | 'RUNTIME_IMPLEMENTATION_MISMATCH' | 'COMPATIBILITY_TARGET_MISMATCH' | 'ROLE_IDENTITY_COLLAPSE' | 'INVALID_COMPOSITION_PACKAGE' | 'INCOMPATIBLE_SELECTED_COMPOSITION';
/**
 ...
 */
export declare class CompositionIntakeError extends Error {
