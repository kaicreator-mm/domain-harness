...
import type { RuntimeFailure, WorkflowAddress, WorkflowInstanceSnapshot } from '../v2/contracts/workflow.js';
/**
 ...
 */
export type CommandOutcomeSnapshot = AppliedCommandOutcome | RejectedCommandOutcome | FailedCommandOutcome | AbandonedCommandOutcome;
...
export type ProcessedCommandResolution = AppliedCommandResolution | RejectedCommandResolution;
/**
...
export type ProcessCommandRuntimeStore = Pick<RuntimeStore, 'getInstance' | 'getMessageDisposition'> & RuntimeStoreProcessCommandExtension;
export type ProcessCommandContractErrorCode = 'INVALID_PROCESS_DATA' | 'INVALID_COMMAND_RESOLUTION' | 'TARGET_MISMATCH' | 'TARGET_SEQUENCE_MISMATCH' | 'STATE_REVISION_MISMATCH' | 'COMMAND_TURN_NOT_PROCESSING' | 'COMMAND_OUTCOME_MISSING' | 'COMMAND_OUTCOME_CONFLICT' | 'COMMAND_OUTCOME_MISMATCH' | 'NORMAL_OUTCOME_CANNOT_REQUIRE_RECOVERY';
export declare class ProcessCommandContractError extends Error {
