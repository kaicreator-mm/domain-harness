import { assertRuntimeEvidenceUsable, } from '../contracts/runtime-evidence.js';
/**
 ...
 */
export function assertEvidenceUsableForGovernedEvaluation(record, use) {
 ...
 */
export function assertEvidenceUsableForObservation(record, use) {
    assertRuntimeEvidenceUsable(record, {
        target: use.target,
        ...(use.externalScopeContract === undefined
            ? {}
...
//# sourceMappingURL=use-gate.js.map