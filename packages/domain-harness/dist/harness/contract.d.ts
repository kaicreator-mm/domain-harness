 ...
 */
export type BusinessHarnessFailureCode = 'CANCELLED' | 'INVALID_CONFIGURATION' | 'INVALID_MODEL_RESPONSE' | 'INVALID_STRUCTURED_RESULT' | 'MAX_STEPS_EXHAUSTED' | 'MODEL_ERROR' | 'MUTATION_CAPABILITY_FORBIDDEN' | 'QUERY_OUTPUT_INVALID' | 'UNKNOWN_CAPABILITY';
...
export type DecisionTraceEntryType = 'prepare' | 'model.request' | 'model.response' | 'query.call' | 'query.observation' | 'final.accepted' | 'failed' | 'cancelled';
/**
...
export interface ModelPort {
    generate(request: BusinessHarnessModelRequest, signal: AbortSignal): Promise<BusinessHarnessModelResponse>;
}
/**
...
export type BusinessHarnessEvent = {
