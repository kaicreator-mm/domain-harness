...
export type MessageAcceptanceStore = Pick<RuntimeStore, 'getInstance' | 'acceptMessage' | 'getMessageDisposition'>;
...
export type MessageAcceptanceErrorCode = 'invalid_message' | 'target_not_found' | 'target_not_accepting' | 'pinned_package_missing' | 'workflow_not_found' | 'message_contract_not_found' | 'contract_version_mismatch' | 'payload_contract_violation' | 'invalid_pinned_contract' | 'store_invariant_violation';
export declare class MessageAcceptanceError extends Error {
    readonly code: MessageAcceptanceErrorCode;
    constructor(code: MessageAcceptanceErrorCode, message: string, options?: ErrorOptions);
}
//# sourceMappingURL=message-acceptance.d.ts.map