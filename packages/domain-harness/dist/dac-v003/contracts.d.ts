 ...
 */
export declare const DAC_V003_REFERENCE_ADAPTER_VERSION: "dac-v003-reference-adapter/1";
/**
 ...
 */
export declare const DAC_V003_BASELINE: {
    readonly contract: "domain-application-contract";
    readonly version: "v0.0.3";
    readonly semanticFreezeCommit: "3322b2152253b3c60f254c23a4f9ab1a14e063d1";
    readonly semanticFreezeTree: "163d2a4d9eb5b1659f35df1a0bb73bcaef96cd06";
};
...
export declare const DAC_V003_FOUNDATION_ROLES: readonly ["runtime-host-binding-requirement", "runtime-host-binding", "runtime-interaction-contract"];
 ...
 */
export declare const DAC_V003_UNSAFE_ALIAS_GROUPS: readonly [readonly ["runtime-host-binding-requirement", "runtime-host-binding", "runtime-binding"], readonly ["logical-operation", "evolution-operation", "authoring-capability-request"], readonly ["domain-data-revision", "authored-candidate", "evolved-candidate", "selected-domain-data"]];
/**
 * Required role inequalities beyond the unsafe-alias groups
 * (CROSS_LAYER_REFERENCES §6.5, v0.0.2 frozen, retained in v0.0.3).
 */
export declare const DAC_V003_REQUIRED_ROLE_INEQUALITIES: readonly ["application-selection != compatibility-validation", "compatibility-validation != runtime-binding", "runtime-binding != runtime-activation", "runtime-contract != runtime-implementation", "promotion-decision != application-selection"];
/**
...
export type DacV003Reference = RuntimeHostBindingRequirementRef | RuntimeHostBindingRef | RuntimeInteractionContractRef | DacV003RegistryReference;
 ...
 */
export declare const DAC_V003_EXACTNESS_PROFILES: readonly ["P0", "P1", "P2", "P3", "P4", "P5", "P6", "P7"];
...
export declare const DAC_V003_PROFILE_REQUIREMENTS: Readonly<Record<DacV003ExactnessProfile, DacV003ProfileRequirements>>;
/**
 ...
 * V3-002.
 */
export declare const DAC_V003_REFERENCE_DISPOSITIONS: readonly ["FAIL_CLOSED", "STALE", "INCOMPATIBLE", "REQUIRES_RECONCILIATION", "REQUIRES_EXPLICIT_RESELECTION", "COMPATIBLE"];
export type DacV003ReferenceDispositionValue = (typeof DAC_V003_REFERENCE_DISPOSITIONS)[number];
export declare const DAC_V003_DISPOSITION_NAMESPACE: "dac-v003/reference-compatibility-disposition";
...
export type DacV003ReferenceErrorCode = 'UNSUPPORTED_DAC_BASELINE' | 'INVALID_REFERENCE' | 'MUTABLE_ALIAS_REJECTED' | 'IDENTITY_MISMATCH' | 'ROLE_MISMATCH' | 'PROFILE_REQUIREMENT_UNMET' | 'REVISION_DIGEST_CONTRADICTION' | 'EXTERNAL_IDENTITY_FORBIDDEN' | 'INVALID_DISPOSITION';
/** Fail-closed error surface for the DAC v0.0.3 reference foundation. */
export declare class DacV003ReferenceError extends Error {
