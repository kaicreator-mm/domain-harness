...
import type { PromotedArtifactIdentity, PromotedArtifactRevocationRecord } from '../promoted-artifact/contracts.js';
import type { DynamicChildExecutionErrorCode, DynamicChildExecutionPin, DynamicChildInvocationSlot, PromotedChildArtifactPort, PromotedChildEffectIntentData, PromotedChildEmittedEvent, PromotedChildInvokingContext, PromotedChildSelector } from '../promoted-child/contracts.js';
import type { PromotedChildQueryExecutorPort, PromotedChildRuntime } from '../promoted-child/runtime.js';
import type { ExactSemanticCacheStore, ObservedDependencySet, RequiredSemanticProjection, SemanticCacheBypassReason, SemanticCacheCurrentSchema, SemanticCacheEntry, SemanticCacheKey, SemanticCacheWriteIneligibleReason } from '../semantic-cache/exact-semantic-cache.js';
/**
...
export declare class DecisionResolverError extends Error {
...
export type DecisionResolverTelemetryEvent = {
    readonly type: 'revocation-fallthrough';
    readonly artifact: CompiledArtifactIdentity;
    readonly recordId: string;
} | {
    readonly type: 'promoted-not-found';
    ...
    readonly type: 'cache-store-error';
    readonly operation: 'read' | 'write';
    readonly message: string;
} | {
    readonly type: 'cache-write-ineligible';
    readonly reason: string;
