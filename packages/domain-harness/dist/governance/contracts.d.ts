import type { ContentDigest, ExactContentIdentity } from '../contracts/identity.js';
...
export type GovernanceRetentionReason = 'active-execution' | 'recoverable-execution' | 'audit' | 'validation' | 'promotion';
...
export type GovernanceContractErrorCode = 'INVALID_GOVERNANCE_IDENTITY' | 'GOVERNANCE_DIGEST_MISMATCH' | 'GOVERNANCE_BODY_CONFLICT' | 'MISSING_RETAINED_GOVERNANCE_BASELINE' | 'CORRUPT_RETAINED_GOVERNANCE_BASELINE' | 'INVALID_PACKAGE_CDI_BINDING' | 'GOVERNANCE_DOMAIN_MISMATCH' | 'NON_GOVERNANCE_REQUIRES_OPERATOR_AUTHORITY' | 'INVALID_RETENTION_REFERENCE' | 'RETENTION_REFERENCE_CONFLICT' | 'GOVERNANCE_BASELINE_RETAINED';
export declare class GovernanceContractError extends Error {
