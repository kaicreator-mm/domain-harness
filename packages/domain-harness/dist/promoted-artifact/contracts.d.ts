...
export declare const PROMOTED_ARTIFACT_KIND: "promoted-subworkflow";
...
export interface PromotedArtifactProducerInvalidationPort {
    invalidateProducedResults(artifact: PromotedArtifactIdentity, revocation: PromotedArtifactRevocationRecord): Promise<void>;
}
...
export type PromotedArtifactContractErrorCode = 'PROMOTION_REQUIRES_VALIDATED_CANDIDATE' | 'PROMOTION_AUTHORITY_MISMATCH' | 'PROMOTION_VALIDATION_DRIFT' | 'INVALID_PROMOTED_ARTIFACT' | 'PROMOTED_ARTIFACT_DIGEST_MISMATCH' | 'PROMOTED_ARTIFACT_BODY_CONFLICT' | 'PROMOTED_ARTIFACT_NOT_FOUND' | 'PROMOTED_ARTIFACT_NOT_PROMOTED' | 'PROMOTED_ARTIFACT_AUTHORITY_MISMATCH' | 'PROMOTED_ARTIFACT_VERSION_NOT_FOUND' | 'PROMOTED_ARTIFACT_VERSION_REBIND' | 'PROMOTED_ARTIFACT_ALIAS_NOT_FOUND' | 'PROMOTED_ARTIFACT_STALE_SELECTION' | 'PROMOTED_ARTIFACT_REVOKED' | 'PROMOTED_ARTIFACT_REVOCATION_CONFLICT' | 'PROMOTED_ARTIFACT_INVALIDATION_FAILED' | 'PROMOTED_ARTIFACT_RETENTION_NOT_FOUND' | 'PROMOTED_ARTIFACT_RETENTION_REBIND' | 'PROMOTED_ARTIFACT_STALE_RELEASE';
export declare class PromotedArtifactContractError extends Error {
