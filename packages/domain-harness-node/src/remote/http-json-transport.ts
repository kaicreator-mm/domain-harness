...
export interface NodeHttpJsonRemoteTransportOptions {
...
export function createNodeHttpJsonRemoteTransport(options: NodeHttpJsonRemoteTransportOptions): RemoteTransportPort {
  const fetchImpl = options.fetchImpl ?? globalThis.fetch;
  if (typeof fetchImpl !== 'function') {
    throw new HttpJsonTransportError('RESOURCE_INVALID', 'Node host does not provide fetch');
  }
